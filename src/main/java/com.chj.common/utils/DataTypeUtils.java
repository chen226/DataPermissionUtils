...
public class DataTypeUtils {
	 ...
	 * @return
	 */
	public static Boolean checkType(String dataType) {
		String jdbcType = getJdbcType(dataType.toUpperCase());
		if(jdbcType.equals(VARBINARY)||jdbcType.equals(BLOB)||jdbcType.equals(CLOB)
				||jdbcType.equals(SMALLINT)||jdbcType.equals(TIMESTAMP)||jdbcType.equals(LONGVARCHAR)
				||jdbcType.equals(VARCHAR)){
			return true;
		}
		return false;
	}
